...
single {@link com.sleepycat.jni.db.Database Database} or {@link com.sleepycat.jni.db.Cursor Cursor} get call.
*/
public class MultipleRecnoDataEntry extends MultipleEntry {
    /**
    Construct an entry with no data. The object must be configured
    before use with the {@link com.sleepycat.jni.db.MultipleEntry#setUserBuffer MultipleEntry.setUserBuffer} method.
    */
    ...
    {@link com.sleepycat.jni.db.MultipleEntry#setUserBuffer MultipleEntry.setUserBuffer} method.
    <p>
    @param data
    ...
    */
    ...
    may only be called after a successful call to a {@link com.sleepycat.jni.db.Database Database} or
    {@link com.sleepycat.jni.db.Cursor Cursor} get method with this object as the data parameter.
    <p>
