...
/**
This exception is thrown when a {@link com.sleepycat.jni.db.DatabaseEntry DatabaseEntry}
passed to a {@link com.sleepycat.jni.db.Database Database} or {@link com.sleepycat.jni.db.Cursor Cursor} method is not large
enough to hold a value being returned.  This only applies to
{@link com.sleepycat.jni.db.DatabaseEntry DatabaseEntry} objects configured with the
{@link com.sleepycat.jni.db.DatabaseEntry#setUserBuffer DatabaseEntry.setUserBuffer} method.
...
public class MemoryException extends DatabaseException {
    ...
    /**
    Returns the {@link com.sleepycat.jni.db.DatabaseEntry DatabaseEntry} object with insufficient memory
