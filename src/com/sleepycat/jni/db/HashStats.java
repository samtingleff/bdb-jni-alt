...
public class HashStats extends DatabaseStats {
    ...
    */
    ...
    <p>
    If the {@link com.sleepycat.jni.db.Database#getStats Database.getStats} call was configured by the
    {@link com.sleepycat.jni.db.StatsConfig#setFast StatsConfig.setFast} method, the count will be the last
