...
public final class ReplicationStatus {
    ...
    */
    ...
    {@link com.sleepycat.jni.db.Environment#startReplication Environment.startReplication} is available from the
    ...
    */
    ...
    parameter to the {@link com.sleepycat.jni.db.Environment#startReplication Environment.startReplication} is available
    ...
    */
    ...
    this is the same as the environment ID passed to {@link com.sleepycat.jni.db.Environment#processReplicationMessage Environment.processReplicationMessage}.  However, if a new master is elected, this
