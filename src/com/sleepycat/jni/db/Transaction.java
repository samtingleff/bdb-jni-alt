...
{@link com.sleepycat.jni.db.Transaction#abort Transaction.abort}, {@link com.sleepycat.jni.db.Transaction#commit Transaction.commit} or
{@link com.sleepycat.jni.db.Transaction#discard Transaction.discard}
...
not yet been committed or aborted) except for {@link com.sleepycat.jni.db.Environment#beginTransaction Environment.beginTransaction}, {@link com.sleepycat.jni.db.Transaction#abort Transaction.abort} and {@link com.sleepycat.jni.db.Transaction#commit Transaction.commit}.
<p>
...
public class Transaction {
    ...
    {@link com.sleepycat.jni.db.Transaction Transaction} handle may not be accessed again.
    <p>
    <p>
...
<p>
After this method returns the {@link com.sleepycat.jni.db.Transaction Transaction} handle may not be
...
configured using the {@link com.sleepycat.jni.db.EnvironmentConfig#setTxnNoSync EnvironmentConfig.setTxnNoSync} method.  This
behavior may also be set for a single transaction using the
{@link com.sleepycat.jni.db.Environment#beginTransaction Environment.beginTransaction} method.  Any value specified to
...
{@link com.sleepycat.jni.db.EnvironmentConfig#setTxnNoSync EnvironmentConfig.setTxnNoSync} method or for a single transaction
using the {@link com.sleepycat.jni.db.Environment#beginTransaction Environment.beginTransaction} method.  Any value
...
<p>
This behavior may be set for a database environment using the
{@link com.sleepycat.jni.db.EnvironmentConfig#setTxnWriteNoSync EnvironmentConfig.setTxnWriteNoSync} method or for a single
transaction using the {@link com.sleepycat.jni.db.Environment#beginTransaction Environment.beginTransaction} method.
...
@throws DatabaseException if a failure occurs.
    */
    ...
    {@link com.sleepycat.jni.db.Transaction Transaction} handle, neither committing nor aborting the
    transaction.  This call may be used only after calls to
    {@link com.sleepycat.jni.db.Environment#recover Environment.recover} when there are multiple global
    transaction managers recovering transactions in a single database
    environment.  Any transactions returned by {@link com.sleepycat.jni.db.Environment#recover Environment.recover} that are not handled by the current global transaction
    manager should be discarded using this method.
    <p>
    The {@link com.sleepycat.jni.db.Transaction Transaction} handle may not be accessed again after this
...
@throws DatabaseException if a failure occurs.
    */
    ...
    {@link com.sleepycat.jni.db.Environment#getLock Environment.getLock} or {@link com.sleepycat.jni.db.Environment#lockVector Environment.lockVector}
    calls.
    <p>
    @return
...
@throws DatabaseException if a failure occurs.
    ...
    */
    ...
    {@link com.sleepycat.jni.db.Transaction#prepare Transaction.prepare} call and await its successful return
    ...
    {@link com.sleepycat.jni.db.Environment#recover Environment.recover} method, telling the application which
...
@throws DatabaseException if a failure occurs.
    ...
    */
    ...
    may throw {@link com.sleepycat.jni.db.DatabaseException DatabaseException}.
    <p>
