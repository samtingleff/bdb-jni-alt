...
public class SequenceConfig implements Cloneable {
    ...
    */
    ...
    /**
Configure the {@link com.sleepycat.jni.db.Database#openSequence Database.openSequence} method to
...
configure the {@link com.sleepycat.jni.db.Database#openSequence Database.openSequence} method to
    ...
    */
    ...
    /**
Return true if the {@link com.sleepycat.jni.db.Database#openSequence Database.openSequence} method is configured
    to create the sequence if it does not already exist.
<p>
This method may be called at any time during the life of the application.
<p>
@return
True if the {@link com.sleepycat.jni.db.Database#openSequence Database.openSequence} method is configured
    to create the sequence if it does not already exist.
    */
...
configure the {@link com.sleepycat.jni.db.Database#openSequence Database.openSequence} method to
    ...
    */
    ...
    /**
Return true if the {@link com.sleepycat.jni.db.Database#openSequence Database.openSequence} method is configured to
    fail if the database already exists.
<p>
This method may be called at any time during the life of the application.
<p>
@return
True if the {@link com.sleepycat.jni.db.Database#openSequence Database.openSequence} method is configured to
    fail if the database already exists.
    */
