...
<p>
Environment handles are free-threaded unless {@link com.sleepycat.jni.db.EnvironmentConfig#setThreaded EnvironmentConfig.setThreaded} is called to disable this before the environment is opened.
<p>
...
{@link com.sleepycat.jni.db.Database Database} or {@link com.sleepycat.jni.db.Transaction Transaction}.  Once {@link com.sleepycat.jni.db.Environment#close Environment.close}
...
public class Environment {
    ...
    */
    ...
    <p>
    The {@link com.sleepycat.jni.db.Environment Environment} handle should not be closed while any other
    ...
    or aborted.  Specifically, this includes {@link com.sleepycat.jni.db.Database Database},
    {@link com.sleepycat.jni.db.Cursor Cursor}, {@link com.sleepycat.jni.db.Transaction Transaction}, and {@link com.sleepycat.jni.db.LogCursor LogCursor}
    handles.
    <p>
    ...
    {@link com.sleepycat.jni.db.Environment Environment} handle may not be accessed again.
    <p>
    <p>
@throws DatabaseException if a failure occurs.
    */
    ...
    <p>
    After this method has been called, regardless of its return, the
    {@link com.sleepycat.jni.db.Environment Environment} handle may not be 
    accessed again.
    <p>
    @param home
...
{@link com.sleepycat.jni.db.DatabaseConfig#setTransactional DatabaseConfig.setTransactional} on the configuration object.
<p>
@param fileName
...
@throws DatabaseException if a failure occurs.
    */
    ...
    with an existing lock, throw a {@link com.sleepycat.jni.db.LockNotGrantedException LockNotGrantedException}
...
@throws DatabaseException if a failure occurs.
    */
    ...
    <p>
    Call {@link com.sleepycat.jni.db.Environment#freeLockerID Environment.freeLockerID} to return the locker ID to
...
@throws DatabaseException if a failure occurs.
    */
    ...
    {@link com.sleepycat.jni.db.LockNotGrantedException#getIndex LockNotGrantedException.getIndex}.
    <p>
    @param locker
    An unsigned 32-bit integer quantity representing the entity
    requesting the lock.
    <p>
    @param list
    An array of {@link com.sleepycat.jni.db.LockRequest LockRequest} objects, listing the requested lock
    operations.
    <p>
    <p>
@throws DatabaseException if a failure occurs.
...
@throws DatabaseException if a failure occurs.
    */
    ...
    to send replication messages by calling {@link com.sleepycat.jni.db.EnvironmentConfig#setReplicationTransport EnvironmentConfig.setReplicationTransport}.
    <p>
    @param cdata
...
@throws DatabaseException if a failure occurs.
    **/
    ...
    be processed using the same {@link com.sleepycat.jni.db.Environment Environment} handle.  It is not
    ...
    <p>
    @return
    A {@link com.sleepycat.jni.db.ReplicationStatus ReplicationStatus} object.
    */
...
@throws DatabaseException if a failure occurs.
    **/
    ...
    See {@link com.sleepycat.jni.db.ReplicationManagerStartPolicy ReplicationManagerStartPolicy} for more information.
    **/
...
@throws DatabaseException if a failure occurs.
    ...
    */
    ...
    except for {@link com.sleepycat.jni.db.Environment#beginTransaction Environment.beginTransaction},
    {@link com.sleepycat.jni.db.Transaction#abort Transaction.abort} and {@link com.sleepycat.jni.db.Transaction#commit Transaction.commit} --
    ...
    should be passed as an parameter to {@link com.sleepycat.jni.db.Transaction#prepare Transaction.prepare}.
    <p>
    @param config
...
@throws DatabaseException if a failure occurs.
    */
    ...
    call library functions, throwing a {@link com.sleepycat.jni.db.RunRecoveryException RunRecoveryException}.
    <p>
    This method configures a database environment, including all threads
of control accessing the database environment, not only the operations
performed using a specified {@link com.sleepycat.jni.db.Environment Environment} handle.
