...
public final class LockOperation {
    ...
    the specified locker.  Upon return from {@link com.sleepycat.jni.db.Environment#lockVector Environment.lockVector}, if the lock field is non-null, a reference to the
    acquired lock is stored there.  (This reference is invalidated by
    any call to {@link com.sleepycat.jni.db.Environment#lockVector Environment.lockVector} or {@link com.sleepycat.jni.db.Environment#putLock Environment.putLock} that releases the lock.)
    */
    ...
    */
    ...
    performed by the current call to {@link com.sleepycat.jni.db.Environment#lockVector Environment.lockVector}
