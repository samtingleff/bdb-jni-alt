...
<p>
Storage and retrieval for the {@link com.sleepycat.jni.db.Database Database} and {@link com.sleepycat.jni.db.Cursor Cursor} methods
...
{@link com.sleepycat.jni.db.Database Database} or {@link com.sleepycat.jni.db.Cursor Cursor} methods, the results are undefined.
<p>
DatabaseEntry objects may be used in conjunction with the object mapping
support provided in the {@link com.sleepycat.jni.bind} package.
<p>
...
public class DatabaseEntry {
    ...
    */
    ...
    <p>
    It is an error to attempt a partial store using the {@link com.sleepycat.jni.db.Database#put Database.put} method in a database that supports duplicate records. Partial
...
The length of the application's buffer.
    */
    ...
    {@link com.sleepycat.jni.db.MemoryException MemoryException} is thrown.
    <p>
    Applications can determine the length of a record by setting
    <code>length</code> to 0 and calling {@link com.sleepycat.jni.db.DatabaseEntry#getSize DatabaseEntry.getSize}
    on the return value.
    <p>
    @param length
