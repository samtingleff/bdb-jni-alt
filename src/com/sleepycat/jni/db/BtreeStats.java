...
public class BtreeStats extends DatabaseStats {
    ...
    */
    ...
    the {@link com.sleepycat.jni.db.Database#getStats Database.getStats} call was not configured by the
    {@link com.sleepycat.jni.db.StatsConfig#setFast StatsConfig.setFast} method or the database was configured
    ...
    will be exact.  Otherwise, if the {@link com.sleepycat.jni.db.Database#getStats Database.getStats} call
    was configured by the {@link com.sleepycat.jni.db.StatsConfig#setFast StatsConfig.setFast} method, the
    count will be exact but will include deleted records; if the
    {@link com.sleepycat.jni.db.Database#getStats Database.getStats} call was not configured by the
    {@link com.sleepycat.jni.db.StatsConfig#setFast StatsConfig.setFast} method, the count will be exact and
    ...
    */
    ...
    database.  If the {@link com.sleepycat.jni.db.Database#getStats Database.getStats} call was not
    configured by the {@link com.sleepycat.jni.db.StatsConfig#setFast StatsConfig.setFast} method, the count
    ...
    count will be exact.  Otherwise, if the {@link com.sleepycat.jni.db.Database#getStats Database.getStats}
    call was configured by the {@link com.sleepycat.jni.db.StatsConfig#setFast StatsConfig.setFast} method, the
    count will be exact but will include deleted records; if the
    {@link com.sleepycat.jni.db.Database#getStats Database.getStats} call was not configured by the
    {@link com.sleepycat.jni.db.StatsConfig#setFast StatsConfig.setFast} method, the count will be exact and
    will not include deleted records.
...
<p>
The information is only included if the {@link com.sleepycat.jni.db.Database#getStats Database.getStats} call
was not configured by the {@link com.sleepycat.jni.db.StatsConfig#setFast StatsConfig.setFast} method.
    */
