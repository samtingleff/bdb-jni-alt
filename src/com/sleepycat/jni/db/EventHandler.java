...
<p>
The {@link com.sleepycat.jni.db.EnvironmentConfig#setEventHandler EnvironmentConfig.setEventHandler} is used to provide
...
public interface EventHandler {
    ...
    {@link com.sleepycat.jni.db.RunRecoveryException RunRecoveryException} exceptions. It is often easier to simply exit
    ...
    */
    ...
    the {@link com.sleepycat.jni.db.Environment#startReplication Environment.startReplication} method after receiving this
    ...
    Replication Manager calls {@link com.sleepycat.jni.db.Environment#startReplication Environment.startReplication}
    automatically on behalf of the application when appropriate (resulting in
    firing of the {@link com.sleepycat.jni.db.EventHandler#handleRepMasterEvent EventHandler.handleRepMasterEvent} event).
    */
    ...
    */
    ...
    configured with {@link com.sleepycat.jni.db.EnvironmentConfig#setReplicationManagerAckPolicy EnvironmentConfig.setReplicationManagerAckPolicy})
