 ...
 * instance, which is also a {@link com.sleepycat.jni.util.FastOutputStream}
...
public class TupleBase {
     ...
     * com.sleepycat.jni.util.FastOutputStream#DEFAULT_INIT_SIZE} size will be
     * used.</p>
     */
    public TupleBase() {
        outputBufferSize = 0;
     ...
     * com.sleepycat.jni.util.FastOutputStream#DEFAULT_INIT_SIZE} size is used.</p>
     *
     ...
     * {@link com.sleepycat.jni.util.FastOutputStream#reset} method before each
     * use.</p>
     *
