...
import static com.sleepycat.jni.asm.Opcodes.ACC_ABSTRACT;
import static com.sleepycat.jni.asm.Opcodes.ACC_PRIVATE;
import static com.sleepycat.jni.asm.Opcodes.ACC_PUBLIC;
import static com.sleepycat.jni.asm.Opcodes.ACC_STATIC;
import static com.sleepycat.jni.asm.Opcodes.ACC_TRANSIENT;
import static com.sleepycat.jni.asm.Opcodes.ACONST_NULL;
import static com.sleepycat.jni.asm.Opcodes.ALOAD;
import static com.sleepycat.jni.asm.Opcodes.ANEWARRAY;
import static com.sleepycat.jni.asm.Opcodes.ARETURN;
import static com.sleepycat.jni.asm.Opcodes.BIPUSH;
import static com.sleepycat.jni.asm.Opcodes.CHECKCAST;
import static com.sleepycat.jni.asm.Opcodes.DCMPL;
import static com.sleepycat.jni.asm.Opcodes.DCONST_0;
import static com.sleepycat.jni.asm.Opcodes.DUP;
import static com.sleepycat.jni.asm.Opcodes.FCMPL;
import static com.sleepycat.jni.asm.Opcodes.FCONST_0;
import static com.sleepycat.jni.asm.Opcodes.GETFIELD;
import static com.sleepycat.jni.asm.Opcodes.GOTO;
import static com.sleepycat.jni.asm.Opcodes.ICONST_0;
import static com.sleepycat.jni.asm.Opcodes.ICONST_1;
import static com.sleepycat.jni.asm.Opcodes.ICONST_2;
import static com.sleepycat.jni.asm.Opcodes.ICONST_3;
import static com.sleepycat.jni.asm.Opcodes.ICONST_4;
import static com.sleepycat.jni.asm.Opcodes.ICONST_5;
import static com.sleepycat.jni.asm.Opcodes.IFEQ;
import static com.sleepycat.jni.asm.Opcodes.IFGT;
import static com.sleepycat.jni.asm.Opcodes.IFLE;
import static com.sleepycat.jni.asm.Opcodes.IFNE;
import static com.sleepycat.jni.asm.Opcodes.IFNONNULL;
import static com.sleepycat.jni.asm.Opcodes.IF_ICMPNE;
import static com.sleepycat.jni.asm.Opcodes.ILOAD;
import static com.sleepycat.jni.asm.Opcodes.INVOKEINTERFACE;
import static com.sleepycat.jni.asm.Opcodes.INVOKESPECIAL;
import static com.sleepycat.jni.asm.Opcodes.INVOKESTATIC;
import static com.sleepycat.jni.asm.Opcodes.INVOKEVIRTUAL;
import static com.sleepycat.jni.asm.Opcodes.IRETURN;
import static com.sleepycat.jni.asm.Opcodes.ISUB;
import static com.sleepycat.jni.asm.Opcodes.LCMP;
import static com.sleepycat.jni.asm.Opcodes.LCONST_0;
import static com.sleepycat.jni.asm.Opcodes.NEW;
import static com.sleepycat.jni.asm.Opcodes.POP;
import static com.sleepycat.jni.asm.Opcodes.PUTFIELD;
import static com.sleepycat.jni.asm.Opcodes.RETURN;
...
import com.sleepycat.jni.asm.AnnotationVisitor;
import com.sleepycat.jni.asm.Attribute;
import com.sleepycat.jni.asm.ClassAdapter;
import com.sleepycat.jni.asm.ClassVisitor;
import com.sleepycat.jni.asm.FieldVisitor;
import com.sleepycat.jni.asm.Label;
import com.sleepycat.jni.asm.MethodVisitor;
import com.sleepycat.jni.asm.Type;
