...
import com.sleepycat.jni.asm.ClassReader;
import com.sleepycat.jni.asm.ClassVisitor;
import com.sleepycat.jni.asm.ClassWriter;
...
public class ClassEnhancer implements ClassFileTransformer {
     ...
     * date.  For example:
     *
     * <pre class="code">java -cp je-&lt;version&gt;.jar com.sleepycat.jni.persist.model.ClassEnhancer ./classes</pre>
     *
